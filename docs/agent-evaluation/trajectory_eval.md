...
- [Error Span](../annotation-types/text/error_span.md) — similar MQM-style error annotation for text
- [Rubric Evaluation](../annotation-types/measurement/rubric_eval.md) — multi-criteria evaluation grid
- [Schemas and Templates](../annotation-types/schemas_and_templates.md) — gallery of all annotation types
