...
- [Agent Trace Display](../annotation-types/schemas_and_templates.md) — Standard agent trace step cards
- [Configuration Reference](../configuration/configuration.md) — Full configuration options
- [Trace Converters](../configuration/configuration.md) — Converting between trace formats
