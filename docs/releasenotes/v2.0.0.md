# Release Notes: v2.0.0 — Backend Refactor
...
See [MIGRATION.md](https://github.com/davidjurgens/potato/blob/master/MIGRATION.md) for detailed instructions on upgrading from v1.x to v2.0.0.
