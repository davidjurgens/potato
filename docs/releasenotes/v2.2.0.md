...
- See [Event Annotation Guide](../event_annotation.md) for details
...
- See [Entity Linking Guide](../entity_linking.md) for configuration
...
- See [Triage Guide](../triage.md) for setup
...
- See [Pairwise Annotation Guide](../pairwise_annotation.md) for details
...
- See [Conversation Tree Guide](../conversation_tree_annotation.md) for details
...
- See [Coreference Annotation Guide](../coreference_annotation.md) for details
...
- See [MACE Guide](../mace.md) for details
...
- See [Option Highlighting Guide](../option_highlighting.md) for configuration
...
- See [Diversity Ordering Guide](../diversity_ordering.md) for details
...
- See [Export Formats Guide](../export_formats.md) for details
...
- See [Remote Data Sources Guide](../remote_data_sources.md) for setup
...
- See [Survey Instruments Guide](../survey_instruments.md) for the full catalog
...
- See [Annotation Navigation Guide](../annotation_navigation.md) for details

### Form Layout Grid
- Arrange annotation schemas in multi-column grid layouts
- CSS Grid-based positioning with configurable column spans
- See [Form Layout Guide](../form_layout.md) for configuration
...
- See [Conditional Logic Guide](../conditional_logic.md) for details
