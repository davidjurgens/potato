...
- [AI Support](../ai-intelligence/ai_support.md) — General AI endpoint configuration
- [Active Learning](../ai-intelligence/active_learning_guide.md) — ML-based instance prioritization (non-Solo Mode)
