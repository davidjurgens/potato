...
- [Instance Display](../annotation-types/instance_display.md) - Configure what content to show
- [Annotation Schemas](../annotation-types/schemas_and_templates.md) - Available annotation types
