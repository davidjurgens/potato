...
- [Quality Control](../workflow/quality_control.md) -- Attention checks and gold standards for annotator quality.
- [Task Assignment](../advanced/task_assignment.md) -- Configuring how items are assigned to annotators.
- [Behavioral Tracking](../advanced/behavioral_tracking.md) -- Understanding the timing data shown in adjudication.
- [Admin Dashboard](admin_dashboard.md) -- Monitoring overall annotation progress.
- [Data Format](../configuration/data_format.md) -- Input and output data format details.
