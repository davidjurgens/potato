...
**Permission errors writing annotations** — the container runs as uid 1000. On
Linux, either `chown -R 1000:1000` the project directory or add
`--user "$(id -u):$(id -g)"`. Docker Desktop on macOS and Windows maps ownership
for you.
