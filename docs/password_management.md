...
This endpoint requires the `admin_api_key` configured in your project (see [Admin Dashboard](admin_dashboard.md)).
...
- [Admin Dashboard](admin_dashboard.md) - Admin API key configuration
