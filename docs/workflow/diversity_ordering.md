...
- [Task Assignment Strategies](../advanced/task_assignment.md) - Other assignment strategies
- [AI Support](../ai-intelligence/ai_support.md) - AI label suggestions that integrate with diversity ordering
- [Active Learning Guide](../ai-intelligence/active_learning_guide.md) - ML-based prioritization
