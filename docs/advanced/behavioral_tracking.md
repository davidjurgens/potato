...
See [Admin Dashboard Documentation](../administration/admin_dashboard.md) for details.
...
- [Admin Dashboard](../administration/admin_dashboard.md) - Real-time monitoring
- [Annotation History](../administration/annotation_history.md) - Detailed change tracking
- [Quality Control](../workflow/quality_control.md) - Automated quality checks
- [Data Format](../configuration/data_format.md) - Output file formats
