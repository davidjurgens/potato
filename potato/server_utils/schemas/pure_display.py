...
def _generate_pure_display_layout_internal(annotation_scheme):
    ...
    schematic = f"""
        <form id="{escaped_name}" class="annotation-form pure-display" data-annotation-type="pure_display" data-schema-name="{escaped_name}" action="javascript:void(0)" {layout_attrs}>
